// https://gist.github.com/embedly/422064/
(function($) {
    ...
    var providers = [
        ...
        new OEmbedProvider("youtube", "http|https:\/\/.*youtube\.com\/watch.*", "http://api.embed.ly/v1/api/oembed"),
        new OEmbedProvider("youtube", "http|https:\/\/.*\.youtube\.com\/v\/.*", "http://api.embed.ly/v1/api/oembed"),
        new OEmbedProvider("youtube", "http|https:\/\/youtu\.be\/.*", "http://api.embed.ly/v1/api/oembed"),
        new OEmbedProvider("youtube", "http|https:\/\/.*\.youtube\.com\/user\/.*\#.*", "http://api.embed.ly/v1/api/oembed"),
        new OEmbedProvider("youtube", "http|https:\/\/.*\.youtube\.com\/.*\#.*\/.*", "http://api.embed.ly/v1/api/oembed"),
